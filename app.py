...
if __name__ == "__main__":
    ...
    if uploaded_file is not None:
        ...
        st.write("""
        ## Disclaimer:
        The shorts generated by this application are developed based on the audio. This application is working well for English language audio, and results may vary for other languages. It would be optimized and is currently devloping.
        """)